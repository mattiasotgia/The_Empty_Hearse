...
//         //             classification_type_MC(spill, nu) != particle_data::int_type_t::true_visible_1muNp) continue;
//         //         if (what_to_cut_on == cut_type_t::MC_1mu1p && 
//         //             classification_type_MC(spill, nu) != particle_data::int_type_t::true_visible_1mu1p) continue;
...
//                 classification(spill, &slice) != particle_data::int_type_t::true_visible_1muNp || !truth_cut(&slice)
//             )) {
//                 file << " cut on cut_type_t::TRUE_1muNp && (particle_data::int_type_t::true_visible_1muNp + truth_cut)" << std::endl;
//                 continue;
//             }
//             if (what_to_cut_on == cut_type_t::TRUE_1mu1p && (
//                 classification(spill, &slice) != particle_data::int_type_t::true_visible_1mu1p || !truth_cut(&slice)
//             )) {
//                 file << " cut on cut_type_t::TRUE_1mu1p && (particle_data::int_type_t::true_visible_1mu1p + truth_cut)" << std::endl;
//                 continue;
//             }
//             if (what_to_cut_on == cut_type_t::BOTH_1muNp && (
//                 !reco_cut(&slice) || !truth_cut(&slice) || 
//                 classification(spill, &slice) != particle_data::int_type_t::true_visible_1muNp
//             )) {
//                 file << " cut on cut_type_t::BOTH_1muNp && (particle_data::int_type_t::true_visible_1muNp + truth_cut + reco_cut)" << std::endl;
//                 continue;
//             }
//             if (what_to_cut_on == cut_type_t::BOTH_1mu1p && (
//                 !reco_cut(&slice) || !truth_cut(&slice) || 
//                 classification(spill, &slice) != particle_data::int_type_t::true_visible_1mu1p
//             )) {
//                 file << " cut on cut_type_t::BOTH_1mu1p && (particle_data::int_type_t::true_visible_1mu1p + truth_cut + reco_cut)" << std::endl;
//                 continue;
//             }
//             std::cout << "--> slice #: " << islc  
//                       << " (efficiency = " << slice.tmatch.eff << ", purity = " << slice.tmatch.pur << ")" 
