...
void reco_1mu1p_eff() {
    ...
    std::unique_ptr<ana::Tree> cheated_reco_true_1u1p(new ana::Tree(
        "cheated_reco_true_1u1p", 
    ...
    std::unique_ptr<ana::Tree> cheated_true_1u1p(new ana::Tree(
        "cheated_true_1u1p", 
        {"event", "reco_E", "true_E", "reco_pT"},               ////< 3 labels 
        cheated_loader, 
    ...
    std::unique_ptr<ana::Tree> cheated_reco_1u1p(new ana::Tree(
        "cheated_reco_1u1p", 
        {"event", "reco_E", "true_E", "reco_pT"},               ////< 3 labels 
        cheated_loader, 
    ...
    std::unique_ptr<ana::Tree> nominal_reco_true_1u1p(new ana::Tree(
        "nominal_reco_true_1u1p", 
        {"event", "reco_E", "true_E", "reco_pT"},               ////< 3 labels 
        nominal_loader, 
        {event, spill_reco_E_reco_true_cut, spill_true_E_reco_true_cut, spill_reco_pT_reco_true_cut},     ////< 3 variables
	    cuts::reco::spill_CRTPMTNeutrino
    ...
    std::unique_ptr<ana::Tree> nominal_true_1u1p(new ana::Tree(
        "nominal_true_1u1p", 
        {"event", "reco_E", "true_E", "reco_pT"},               ////< 3 labels 
        nominal_loader, 
        {event, spill_reco_E_true_cut, spill_true_E_true_cut, spill_reco_pT_true_cut},     ////< 3 variables
    ...
    std::unique_ptr<ana::Tree> nominal_reco_1u1p(new ana::Tree(
        "nominal_reco_1u1p", 
        {"event", "reco_E", "true_E", "reco_pT"},               ////< 3 labels 
        nominal_loader, 
        {event, spill_reco_E_reco_cut, spill_true_E_reco_cut, spill_reco_pT_reco_cut},     ////< 3 variables
    ...
    cheated_reco_true_1u1p->SaveTo(file_1mu1p->mkdir("efficiency_plots"));
    cheated_true_1u1p->SaveTo(file_1mu1p->GetDirectory("efficiency_plots"));
    cheated_reco_1u1p->SaveTo(file_1mu1p->GetDirectory("efficiency_plots"));

    std::cout << "__ WRITING : nominal __ " << std::endl;
    nominal_reco_true_1u1p->SaveTo(file_1mu1p->GetDirectory("efficiency_plots"));
    nominal_true_1u1p->SaveTo(file_1mu1p->GetDirectory("efficiency_plots"));
    nominal_reco_1u1p->SaveTo(file_1mu1p->GetDirectory("efficiency_plots"));
};
