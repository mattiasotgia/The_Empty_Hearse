...
const cut_type_t reco_true_1u1p = cut_type_t::BOTH_1muNp;
const cut_type_t true_1u1p = cut_type_t::TRUE_1muNp;
...
void reco_1mu1p_eff_cuts() {
    ...
    std::unique_ptr<TFile> file_1mu1p(new TFile("2k_v2_efficiency_plot_1uNp_cuts.root", "RECREATE"));
